import { Badge, Box, Flex, IconButton, Image, Skeleton, Text, Tooltip, useToast } from '@chakra-ui/react';
...
const ProductCard = ({ product, loading }) => {
  ...
  return (
    <Skeleton isLoaded={!loading} >
        <Box 
          _hover={{ transform: 'scale(1.1)', transitionDuration: '0.5s' }} //chakra ui
          borderWidth='1px'
          overflow='hidden' //dont want bar at side
          p='4'
          shadow='md'>
            {/* from chakra ui displaying images */}
          <Image 
            onMouseEnter={() => setIsShown(true)}  // hover image changes
            ...
            height='200px' 
          />
          {product.stock < 5 ? ( //stock is from model.js
