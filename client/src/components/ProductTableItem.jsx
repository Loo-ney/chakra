...
import { Badge, Button, Flex, FormControl, FormLabel, Input, Switch, Td, Textarea, Tr, VStack, useDisclosure,} from "@chakra-ui/react";
...
const ProductTableItem = ({product}) => {
	...
	const [razorpayId, setRazorpayId] = useState(product.razorpayId);
...
return (
    <>
     <Tr>
        ...
        <Td>
			<Flex direction='column' gap='2'>
				<Input size='sm' value={razorpayId} onChange={(e) => setRazorpayId(e.target.value)} />
